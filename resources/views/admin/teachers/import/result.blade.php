    ...
    <div class="row justify-content-center">
        <div class="col-lg-7">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <p>
                        <strong>{{ session('import_created', 0) }}</strong> enseignant(s) créé(s),
                    ...
                    @if($credentialsToken)
                        <div class="alert alert-warning">
                            ...
                            aux enseignants concernés. Ils ne seront affichés qu'une seule fois via ce lien.
                        </div>
                        <a href="{{ route('admin.teachers.import.credentials', $credentialsToken) }}" class="btn btn-primary">
                    ...
                    <div class="mt-4 d-flex gap-2">
                        <a href="{{ route('admin.teachers.index') }}" class="btn btn-outline-secondary">
                            <i class="fas fa-list me-1"></i> Voir la liste des enseignants
                        </a>
                        <a href="{{ route('admin.teachers.import') }}" class="btn btn-outline-secondary">
