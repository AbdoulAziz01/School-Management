...
@php
    $statCards = [
        ['label' => 'Établissements', 'value' => $stats['schools_total'], 'class' => '', 'url' => route('platform.schools.index')],
        ['label' => 'Actifs', 'value' => $stats['schools_active'], 'class' => 'text-success', 'url' => route('platform.schools.index', ['status' => 'active'])],
        ['label' => 'Inactifs', 'value' => $stats['schools_inactive'], 'class' => $stats['schools_inactive'] ? 'text-warning' : '', 'url' => route('platform.schools.index', ['status' => 'inactive'])],
        ['label' => 'Utilisateurs', 'value' => $stats['users_total'], 'class' => '', 'url' => route('platform.schools.index')],
        ['label' => 'Élèves', 'value' => $stats['students_total'], 'class' => '', 'url' => route('platform.schools.index')],
        ['label' => 'Enseignants', 'value' => $stats['teachers_total'], 'class' => '', 'url' => route('platform.schools.index')],
        ['label' => 'Staff (admin/surv.)', 'value' => $stats['staff_total'], 'class' => '', 'url' => route('platform.schools.index')],
        ['label' => 'Inscriptions en attente', 'value' => $stats['pending_registrations'], 'class' => $stats['pending_registrations'] ? 'text-danger' : '', 'url' => route('platform.schools.index', ['status' => 'pending'])],
    ];
@endphp
...
<div class="row g-3 mb-4">
    @foreach($statCards as $card)
        <div class="col-6 col-md-3 col-xl-2">
            <a href="{{ $card['url'] }}" class="platform-stat-card">
...
<div class="row g-3 mb-4">
    ...
    @if($stats['unassigned_students'] > 0)
        <div class="col-md-4">
            <a href="{{ route('platform.students.unassigned') }}" class="platform-alert-link alert alert-info mb-0 d-flex align-items-center gap-2">
