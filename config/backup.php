...
return [
    ...
    'backup' => [
        ...
        'source' => [
            'files' => [
                 ...
                 * Vide : seule la base de données sera sauvegardée (hébergement mutualisé, espace disque limité).
                 */
                'include' => [
                    //
                ],
    ...
    'notifications' => [
        ...
        'mail' => [
            'to' => env('BACKUP_NOTIFICATION_EMAIL', 'azelie.backup@gmail.com'),
    ...
    'monitor_backups' => [
        [
            ...
            'health_checks' => [
                ...
                // Quota réduit car hébergement mutualisé : ajuster selon l'espace disque disponible.
    ...
    'cleanup' => [
        ...
        'default_strategy' => [
             ...
             * Valeur réduite car hébergement mutualisé : ajuster selon l'espace disque disponible.
             */
