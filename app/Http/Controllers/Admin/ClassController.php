...
class ClassController extends Controller
{
    public function __construct(
        private ClassStatisticsService $classStatistics
    ) {}
    ...
    public function show(SchoolClass $class)
    {
        ...
        // ========= STATISTIQUES DE LA CLASSE (voir ClassStatisticsService) =========
        if ($isReadOnly && $academicYear) {
        ...
        $classStats = $this->classStatistics->calculate($class, $studentIds, $academicYear);
